...
/*****抗混叠滤波器@536Hz*****/
	...
	/*GYRO抗混叠滤波器配置*/
	IMU->WriteReg(0x0B,0xA0);//开启抗混叠和陷波滤波器
	...
	/*ACCEL抗混叠滤波器配置*/
	IMU->WriteReg(0x03,0x18);//开启滤波器 ACCEL_AFF_DELT 12 (default 24)
...
/*****自定义滤波器1号@111Hz*****/
	...
	IMU->WriteReg(0x76,0x00);
	/*滤波器顺序*/
	IMU->WriteReg(0x51,0x12);//GYRO滤波器1st
	IMU->WriteReg(0x53,0x05);//ACCEL滤波器1st
	/*滤波器设置*/
